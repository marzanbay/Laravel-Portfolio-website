    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <p class="footer-text"><i class="fas fa-map-marker-alt"></i> মিরপুর ১০ ঢাকা । </p>
                <p class="footer-text"><i class="fas fa-phone"></i> ০১৭৩০২৩৩৫৯২ </p>
                <p class="footer-text"><i class="fas fa-envelope"></i> Marzanbay@gmail.com</p>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <a class="footer-link" target="_blank" href="{{url('/Policy')}}">প্রাইভেসি পলেসি</a><br>
...
<div class="container-fluid bg-dark text-white m-0 text-center p-3">
    <p class="rights-text  my-2 ">সর্বস্বত্ব মারজান বে দ্বারা সংরক্ষিত; ২০২০ </p>
</div>