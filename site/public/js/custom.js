...
$('#contactSendBtnId').click(function (){
    ...
    SedContact(contactName,contactMobile,contactMsg,contactMsg)
});

function SedContact(contact_name,contact_mobile,contact_email,contact_msg){
    ...
    if (contact_name.length==0) {
        ...
        $('#contactSendBtnId').html('আপনার মেইল লিখুন..')
        setTimeout(function () {
            $('#contactSendBtnId').html('পাঠিয়ে দিন');
        },2000)
    }
        ...
        axios.post('/contactSend',{
            ...
            .then(function (response) {
                if (response.status==200) {
                    if (response.data==1) {
                        $('#contactSendBtnId').html('অনুরোধ সফল হয়ছে')
                        ...
                        $('#contactSendBtnId').html('অনুরোধ ব্যার্থ হয়ছে')
                        setTimeout(function () {
                            $('#contactSendBtnId').html('পাঠিয়ে দিন');
                        },2000)
                    }
